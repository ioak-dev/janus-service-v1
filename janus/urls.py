...
urlpatterns = [
    ...
    path('comment/task/<str:space>/', include('app.comment.urls')),
    path('log/<str:space>/', include('app.log.urls')),
    path('checklistitem/task/<str:space>/', include('app.checklistitem.urls'))
]
